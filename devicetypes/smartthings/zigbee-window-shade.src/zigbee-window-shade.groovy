...
metadata {
	definition(name: "ZigBee Window Shade", namespace: "smartthings", author: "SmartThings", ocfDeviceType: "oic.d.blind", mnmn: "SmartThings", vid: "generic-shade") {
		...
		command "pause"
 		...
 		// NodOn
 		fingerprint profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0102, 1000, FC57", outClusters: "0019", manufacturer: "NodOn", model: "SIN-4-RS-20", deviceJoinName: "NodOn Window Treatment" 
